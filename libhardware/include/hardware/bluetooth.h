...
#include <hardware/mesh/access.h>
#include <hardware/mesh/esp_ble_mesh_provisioning_api.h>
#include <hardware/mesh/esp_ble_mesh_defs.h>
#include <hardware/mesh/esp_ble_mesh_networking_api.h>
#include <hardware/mesh/esp_ble_mesh_common_api.h>
#include <hardware/mesh/mesh_access.h>
...
typedef struct {
    ...
    /** mesh */
    bt_status_t (*ble_mesh_register_prov_callback)(esp_mesh_prov_cb_t callback);
    bt_status_t (*ble_mesh_register_custom_model_callback)(esp_mesh_model_cb_t callback);
    bt_status_t (*ble_mesh_init)(esp_ble_mesh_prov_t *prov, esp_ble_mesh_comp_t *comp);
    bt_status_t (*ble_mesh_node_prov_enable)(esp_ble_mesh_prov_bearer_t bearers);
    //bt_mesh_comp* (*mesh_comp_get)(void);
} bt_interface_t;
