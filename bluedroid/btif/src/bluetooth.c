...
static bt_status_t ble_mesh_register_prov_callback(esp_mesh_prov_cb_t callback)
{
    return (bt_status_t)esp_ble_mesh_register_prov_callback(callback);
}

static bt_status_t ble_mesh_register_custom_model_callback(esp_mesh_model_cb_t callback)
{
    return (bt_status_t)esp_ble_mesh_register_custom_model_callback(callback);
}

static bt_status_t ble_mesh_init(esp_ble_mesh_prov_t *prov, esp_ble_mesh_comp_t *comp)
{
    return (bt_status_t)esp_ble_mesh_init(prov, comp);
}

static bt_status_t ble_mesh_node_prov_enable(esp_ble_mesh_prov_bearer_t bearers)
{
    return (bt_status_t)esp_ble_mesh_node_prov_enable(bearers);
}
/*
static bt_mesh_comp* mesh_comp_get(void)
{
    return (bt_mesh_comp*)bt_mesh_comp_get();
}
*/
static const bt_interface_t bluetoothInterface = {
    ...
    ble_mesh_register_prov_callback,
    ble_mesh_register_custom_model_callback,
    ble_mesh_init,
    ble_mesh_node_prov_enable,
 //   mesh_comp_get,
};
