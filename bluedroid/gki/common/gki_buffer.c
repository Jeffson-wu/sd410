...
void *GKI_getbuf (UINT16 size)
{
    ...
    GKI_exception (GKI_ERROR_BUF_SIZE_ZERO, "jeffson debug");
    if (size == 0)
    {
...
void *GKI_getpoolbuf (UINT8 pool_id)
{
    ...
    GKI_exception (GKI_ERROR_BUF_SIZE_ZERO, "jeffson debug2");
    ...
    /* Make sure the buffers aren't disturbed til finished with allocation */
    GKI_disable();
    GKI_exception (GKI_ERROR_BUF_SIZE_ZERO, "jeffson debug3");
...
#endif
#endif
        GKI_exception (GKI_ERROR_BUF_SIZE_ZERO, "jeffson debug4");
// btla-specific ++
#ifdef GKI_USE_DEFERED_ALLOC_BUF_POOLS
...
// btla-specific --
        ...
        GKI_enable();
        GKI_exception (GKI_ERROR_BUF_SIZE_ZERO, "jeffson debug5");
    ...
    GKI_exception (GKI_ERROR_BUF_SIZE_ZERO, "jeffson debug6");
